...
def sliding_window(img, nwindows=9, margin=20, minpix=1, draw_windows=True, left_color=(0, 0, 255), right_color=(0, 255, 0), thickness=1):
    ...
    '''
    Will be replace with line fit for simplicity
    '''
    ...
    left_fitx = left_fit_[0]*ploty**2 + left_fit_[1] * \
        ploty + left_fit_[2]  # y = ax**2 + bx + c

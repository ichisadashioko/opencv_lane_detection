...
class Lane_Detect:
    ...
    def draw_lane(self, src_img, plot_dsize, leftx_pts, rightx_pts, ploty, color=(255, 0, 0)):
        stretch_ratio = 0.3
    ...
    def pipeline(self,img):
        ...
        s_window, (left_fitx, right_fitx), (left_fit_,right_fit_), ploty = self.sliding_window(lane_mask)
        ...
        draw_lane = self.draw_lane(img, bird_view.shape[:2], left_fitx, right_fitx, ploty)
